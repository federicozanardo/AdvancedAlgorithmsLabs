...
Una volta ricostruito il MST, si effettui la vista in \textit{preorder} di tale albero. 
...
\begin{enumerate}
    ...
    \item \textit{ricostruzione del MST}: il MST ha una cardinalità pari a $|V|$. Il metodo 
    ...
    \item \textit{calcolo del peso del ciclo}: la \verb|_preorder_visit| restituisce il 
...
influire in quanto si verrebbero a determinare delle visite preorder diverse. Conseguenza 
